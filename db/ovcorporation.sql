/*==============================================================*/
/* DBMS name:      MySQL 5.0                                    */
/* Created on:     08/10/2015 01:42:28 p. m.                    */
/*==============================================================*/
...
(
   ...
   activo               bit not null,
   primary key (cve_actividad, cve_tipo, cve_unidad_negocio)
);
...
(
   ...
   activo               bit not null,
   primary key (cve_tipo, cve_unidad_negocio)
);
...
alter table actividades add constraint fk_reference_2 foreign key (cve_tipo, cve_unidad_negocio)
      references tipos_actividades (cve_tipo, cve_unidad_negocio) on delete restrict on update restrict;

alter table calendario_actividades add constraint fk_reference_3 foreign key (cve_actividad, cve_tipo, cve_unidad_negocio)
      references actividades (cve_actividad, cve_tipo, cve_unidad_negocio) on delete restrict on update restrict;
