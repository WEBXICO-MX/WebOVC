...
class Municipio {
    /**
    * @var Estado $cve_estado Tipo Estado
    */        
    private $cve_estado;
    ...
    function __construct1($cveEstado, $cveMunicipio) {
        $this->limpiar();
        $this->cve_estado = new Estado($cveEstado);
    ...
    /**
    * @return Estado Devuelve tipo Estado
    */
    ...
    function get_existe() {
     ...
     /**
     * Establece el estado del municipio.
     *
     * @param Estado $cve_estado Objeto de la clase Estado
     *
     */
